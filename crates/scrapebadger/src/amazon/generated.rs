...
impl Amazon {
    ...
    pub async fn get_bestsellers(&self, params: GetBestsellersParams) -> Result<GetBestsellersResponse> {
    ...
    pub async fn list_categories(&self, params: ListCategoriesParams) -> Result<ListCategoriesResponse> {
    ...
    pub async fn browse_category(&self, params: BrowseCategoryParams) -> Result<BrowseCategoryResponse> {
    ...
    pub async fn get_new_releases(&self, params: GetNewReleasesParams) -> Result<GetNewReleasesResponse> {
    ...
    pub async fn get_product(&self, asin: impl AsRef<str>, params: GetProductParams) -> Result<GetProductResponse> {
    ...
    pub async fn get_offers(&self, asin: impl AsRef<str>, params: GetOffersParams) -> Result<GetOffersResponse> {
    ...
    pub async fn get_reviews(&self, asin: impl AsRef<str>, params: GetReviewsParams) -> Result<GetReviewsResponse> {
    ...
    pub async fn search_products(&self, params: SearchProductsParams) -> Result<SearchProductsResponse> {
    ...
    pub async fn get_seller(&self, seller_id: impl AsRef<str>, params: GetSellerParams) -> Result<GetSellerResponse> {
        let path = format!("/v1/amazon/sellers/{seller_id}", seller_id = seller_id.as_ref());
        let mut q = QueryParams::new();
        q.opt("domain", params.domain.as_ref());
        let query = q.into_pairs();
        let body = None;
    ...
    pub async fn get_seller_feedback(&self, seller_id: impl AsRef<str>, params: GetSellerFeedbackParams) -> Result<GetSellerFeedbackResponse> {
        let path = format!("/v1/amazon/sellers/{seller_id}/feedback", seller_id = seller_id.as_ref());
        let mut q = QueryParams::new();
        q.opt("domain", params.domain.as_ref());
        q.opt("page", params.page.as_ref());
        let query = q.into_pairs();
    ...
    pub async fn get_seller_products(&self, seller_id: impl AsRef<str>, params: GetSellerProductsParams) -> Result<GetSellerProductsResponse> {
        let path = format!("/v1/amazon/sellers/{seller_id}/products", seller_id = seller_id.as_ref());
        let mut q = QueryParams::new();
        q.opt("domain", params.domain.as_ref());
        q.opt("page", params.page.as_ref());
        let query = q.into_pairs();
