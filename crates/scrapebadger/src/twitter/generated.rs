...
impl Twitter {
    ...
    pub async fn search_communities(&self, params: SearchCommunitiesParams) -> Result<CommunitiesResponse> {
    ...
    pub async fn get_community_detail(&self, community_id: impl AsRef<str>, params: GetCommunityDetailParams) -> Result<CommunityData> {
        let path = format!("/v1/twitter/communities/{community_id}", community_id = community_id.as_ref());
    ...
    pub async fn get_community_tweets(&self, community_id: impl AsRef<str>, params: GetCommunityTweetsParams) -> Result<TweetsResponse> {
        let path = format!("/v1/twitter/communities/{community_id}/tweets", community_id = community_id.as_ref());
        let mut q = QueryParams::new();
    ...
    pub async fn get_place_detail(&self, place_id: impl AsRef<str>, params: GetPlaceDetailParams) -> Result<PlaceData> {
        let path = format!("/v1/twitter/geo/places/{place_id}", place_id = place_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
        self.client.send(Method::GET, &path, &query, body).await
    }
    ...
    pub async fn get_list_detail(&self, list_id: impl AsRef<str>, params: GetListDetailParams) -> Result<ListData> {
        let path = format!("/v1/twitter/lists/{list_id}/detail", list_id = list_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
        self.client.send(Method::GET, &path, &query, body).await
    }
    ...
    pub async fn search_list_tweets(&self, list_id: impl AsRef<str>, params: SearchListTweetsParams) -> Result<TweetsResponse> {
        let path = format!("/v1/twitter/lists/{list_id}/search_tweets", list_id = list_id.as_ref());
        let mut q = QueryParams::new();
        q.opt("query", params.query.as_ref());
        q.opt("cursor", params.cursor.as_ref());
        let query = q.into_pairs();
    ...
    pub async fn get_list_tweets(&self, list_id: impl AsRef<str>, params: GetListTweetsParams) -> Result<TweetsResponse> {
        let path = format!("/v1/twitter/lists/{list_id}/tweets", list_id = list_id.as_ref());
        let mut q = QueryParams::new();
        q.opt("cursor", params.cursor.as_ref());
        let query = q.into_pairs();
        let body = None;
    ...
    pub async fn get_broadcast_detail(&self, broadcast_id: impl AsRef<str>, params: GetBroadcastDetailParams) -> Result<BroadcastData> {
        let path = format!("/v1/twitter/spaces/broadcast/{broadcast_id}", broadcast_id = broadcast_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
        self.client.send(Method::GET, &path, &query, body).await
    }
    ...
    pub async fn get_space_detail(&self, space_id: impl AsRef<str>, params: GetSpaceDetailParams) -> Result<SpaceData> {
        let path = format!("/v1/twitter/spaces/{space_id}", space_id = space_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
        self.client.send(Method::GET, &path, &query, body).await
    }
    ...
    pub async fn list_stream_billing_logs(&self, params: ListStreamBillingLogsParams) -> Result<ListStreamBillingLogsResponse> {
    ...
    pub async fn list_filter_rules(&self, params: ListFilterRulesParams) -> Result<ListFilterRulesResponse> {
    ...
    pub async fn create_filter_rule(&self, params: CreateFilterRuleParams) -> Result<FilterRuleResponse> {
        let path = "/v1/twitter/stream/filter-rules".to_string();
        let query: Vec<(String, String)> = Vec::new();
        let mut body = serde_json::Map::new();
        if let Some(v) = &params.interval_seconds { body.insert("interval_seconds".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.max_results_per_poll { body.insert("max_results_per_poll".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.query { body.insert("query".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.tag { body.insert("tag".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.webhook_secret { body.insert("webhook_secret".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.webhook_url { body.insert("webhook_url".to_string(), serde_json::json!(v)); }
    ...
    pub async fn get_filter_rule_pricing_tiers(&self, params: GetFilterRulePricingTiersParams) -> Result<GetFilterRulePricingTiersResponse> {
    ...
    pub async fn validate_filter_rule_query(&self, params: ValidateFilterRuleQueryParams) -> Result<ValidateFilterRuleQueryResponse> {
    ...
    pub async fn get_filter_rule(&self, rule_id: impl AsRef<str>, params: GetFilterRuleParams) -> Result<FilterRuleResponse> {
        let path = format!("/v1/twitter/stream/filter-rules/{rule_id}", rule_id = rule_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
        self.client.send(Method::GET, &path, &query, body).await
    }
    ...
    pub async fn update_filter_rule(&self, rule_id: impl AsRef<str>, params: UpdateFilterRuleParams) -> Result<FilterRuleResponse> {
        let path = format!("/v1/twitter/stream/filter-rules/{rule_id}", rule_id = rule_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let mut body = serde_json::Map::new();
        if let Some(v) = &params.interval_seconds { body.insert("interval_seconds".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.max_results_per_poll { body.insert("max_results_per_poll".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.query { body.insert("query".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.status { body.insert("status".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.tag { body.insert("tag".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.webhook_secret { body.insert("webhook_secret".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.webhook_url { body.insert("webhook_url".to_string(), serde_json::json!(v)); }
        let body = if body.is_empty() { None } else { Some(Value::Object(body)) };
    ...
    pub async fn delete_filter_rule(&self, rule_id: impl AsRef<str>, params: DeleteFilterRuleParams) -> Result<Value> {
        let path = format!("/v1/twitter/stream/filter-rules/{rule_id}", rule_id = rule_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
    ...
    pub async fn get_filter_rule_delivery_logs(&self, rule_id: impl AsRef<str>, params: GetFilterRuleDeliveryLogsParams) -> Result<GetFilterRuleDeliveryLogsResponse> {
        let path = format!("/v1/twitter/stream/filter-rules/{rule_id}/logs", rule_id = rule_id.as_ref());
        let mut q = QueryParams::new();
        q.opt("page", params.page.as_ref());
        q.opt("page_size", params.page_size.as_ref());
        let query = q.into_pairs();
    ...
    pub async fn list_stream_delivery_logs(&self, params: ListStreamDeliveryLogsParams) -> Result<ListStreamDeliveryLogsResponse> {
    ...
    pub async fn list_stream_monitors(&self, params: ListStreamMonitorsParams) -> Result<ListStreamMonitorsResponse> {
    ...
    pub async fn create_stream_monitor(&self, params: CreateStreamMonitorParams) -> Result<StreamMonitorResponse> {
        let path = "/v1/twitter/stream/monitors".to_string();
        let query: Vec<(String, String)> = Vec::new();
        let mut body = serde_json::Map::new();
        if let Some(v) = &params.filter_types { body.insert("filter_types".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.name { body.insert("name".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.usernames { body.insert("usernames".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.webhook_secret { body.insert("webhook_secret".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.webhook_url { body.insert("webhook_url".to_string(), serde_json::json!(v)); }
        let body = if body.is_empty() { None } else { Some(Value::Object(body)) };
        self.client.send(Method::POST, &path, &query, body).await
    ...
    pub async fn get_stream_monitor(&self, monitor_id: impl AsRef<str>, params: GetStreamMonitorParams) -> Result<StreamMonitorResponse> {
        let path = format!("/v1/twitter/stream/monitors/{monitor_id}", monitor_id = monitor_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
        self.client.send(Method::GET, &path, &query, body).await
    }
    ...
    pub async fn update_stream_monitor(&self, monitor_id: impl AsRef<str>, params: UpdateStreamMonitorParams) -> Result<StreamMonitorResponse> {
        let path = format!("/v1/twitter/stream/monitors/{monitor_id}", monitor_id = monitor_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let mut body = serde_json::Map::new();
        if let Some(v) = &params.filter_types { body.insert("filter_types".to_string(), serde_json::json!(v)); }
    ...
    pub async fn delete_stream_monitor(&self, monitor_id: impl AsRef<str>, params: DeleteStreamMonitorParams) -> Result<Value> {
        let path = format!("/v1/twitter/stream/monitors/{monitor_id}", monitor_id = monitor_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
        self.client.send(Method::DELETE, &path, &query, body).await
    ...
    pub async fn list_stream_webhooks(&self, params: ListStreamWebhooksParams) -> Result<ListStreamWebhooksResponse> {
    ...
    pub async fn create_stream_webhook(&self, params: CreateStreamWebhookParams) -> Result<WebhookResponse> {
        let path = "/v1/twitter/stream/webhooks".to_string();
        let query: Vec<(String, String)> = Vec::new();
        let mut body = serde_json::Map::new();
        if let Some(v) = &params.monitor_id { body.insert("monitor_id".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.secret { body.insert("secret".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.url { body.insert("url".to_string(), serde_json::json!(v)); }
        let body = if body.is_empty() { None } else { Some(Value::Object(body)) };
        self.client.send(Method::POST, &path, &query, body).await
    }
    ...
    pub async fn test_stream_webhook(&self, params: TestStreamWebhookParams) -> Result<TestStreamWebhookResponse> {
    ...
    pub async fn delete_stream_webhook(&self, webhook_id: impl AsRef<str>, params: DeleteStreamWebhookParams) -> Result<Value> {
        let path = format!("/v1/twitter/stream/webhooks/{webhook_id}", webhook_id = webhook_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
        self.client.send(Method::DELETE, &path, &query, body).await
    }
    ...
    pub async fn get_trends_by_place(&self, woeid: impl AsRef<str>, params: GetTrendsByPlaceParams) -> Result<PlaceTrendsData> {
    ...
    pub async fn advanced_search_tweets(&self, params: AdvancedSearchTweetsParams) -> Result<TweetsResponse> {
    ...
    pub async fn get_article_detail(&self, article_id: impl AsRef<str>, params: GetArticleDetailParams) -> Result<ArticleData> {
        let path = format!("/v1/twitter/tweets/article/{article_id}", article_id = article_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
        self.client.send(Method::GET, &path, &query, body).await
    }
    ...
    pub async fn get_tweet_detail(&self, tweet_id: impl AsRef<str>, params: GetTweetDetailParams) -> Result<TweetData> {
        let path = format!("/v1/twitter/tweets/tweet/{tweet_id}", tweet_id = tweet_id.as_ref());
        let mut q = QueryParams::new();
        q.opt("cursor", params.cursor.as_ref());
        let query = q.into_pairs();
        let body = None;
    ...
    pub async fn get_tweet_community_notes(&self, tweet_id: impl AsRef<str>, params: GetTweetCommunityNotesParams) -> Result<CommunityNotesResponse> {
        let path = format!("/v1/twitter/tweets/tweet/{tweet_id}/community_notes", tweet_id = tweet_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
        self.client.send(Method::GET, &path, &query, body).await
    }
    ...
    pub async fn get_tweet_edit_history(&self, tweet_id: impl AsRef<str>, params: GetTweetEditHistoryParams) -> Result<TweetsResponse> {
        let path = format!("/v1/twitter/tweets/tweet/{tweet_id}/edit_history", tweet_id = tweet_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
        self.client.send(Method::GET, &path, &query, body).await
    }
    ...
    pub async fn get_tweet_favoriters(&self, tweet_id: impl AsRef<str>, params: GetTweetFavoritersParams) -> Result<UsersResponse> {
        let path = format!("/v1/twitter/tweets/tweet/{tweet_id}/favoriters", tweet_id = tweet_id.as_ref());
        let mut q = QueryParams::new();
        q.opt("cursor", params.cursor.as_ref());
        let query = q.into_pairs();
        let body = None;
    ...
    pub async fn get_tweet_quotes(&self, tweet_id: impl AsRef<str>, params: GetTweetQuotesParams) -> Result<TweetsResponse> {
        let path = format!("/v1/twitter/tweets/tweet/{tweet_id}/quotes", tweet_id = tweet_id.as_ref());
        let mut q = QueryParams::new();
        q.opt("cursor", params.cursor.as_ref());
        let query = q.into_pairs();
        let body = None;
    ...
    pub async fn get_tweet_replies(&self, tweet_id: impl AsRef<str>, params: GetTweetRepliesParams) -> Result<TweetsResponse> {
        let path = format!("/v1/twitter/tweets/tweet/{tweet_id}/replies", tweet_id = tweet_id.as_ref());
        let mut q = QueryParams::new();
        q.opt("cursor", params.cursor.as_ref());
        let query = q.into_pairs();
        let body = None;
    ...
    pub async fn get_tweet_retweeters(&self, tweet_id: impl AsRef<str>, params: GetTweetRetweetersParams) -> Result<UsersResponse> {
        let path = format!("/v1/twitter/tweets/tweet/{tweet_id}/retweeters", tweet_id = tweet_id.as_ref());
        let mut q = QueryParams::new();
        q.opt("cursor", params.cursor.as_ref());
        let query = q.into_pairs();
        let body = None;
    ...
    pub async fn get_similar_tweets(&self, tweet_id: impl AsRef<str>, params: GetSimilarTweetsParams) -> Result<TweetsResponse> {
        let path = format!("/v1/twitter/tweets/tweet/{tweet_id}/similar", tweet_id = tweet_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
        self.client.send(Method::GET, &path, &query, body).await
    }
    ...
    pub async fn get_users_by_usernames(&self, params: GetUsersByUsernamesParams) -> Result<UsersResponse> {
    ...
    pub async fn get_user_articles(&self, user_id: impl AsRef<str>, params: GetUserArticlesParams) -> Result<ArticlesResponse> {
        let path = format!("/v1/twitter/users/{user_id}/articles", user_id = user_id.as_ref());
        let mut q = QueryParams::new();
        q.opt("cursor", params.cursor.as_ref());
        let query = q.into_pairs();
        let body = None;
    ...
    pub async fn get_user_by_id(&self, user_id: impl AsRef<str>, params: GetUserByIdParams) -> Result<UserData> {
        let path = format!("/v1/twitter/users/{user_id}/by_id", user_id = user_id.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
        self.client.send(Method::GET, &path, &query, body).await
    }
    ...
    pub async fn get_user_subscriptions(&self, user_id: impl AsRef<str>, params: GetUserSubscriptionsParams) -> Result<UsersResponse> {
        let path = format!("/v1/twitter/users/{user_id}/subscriptions", user_id = user_id.as_ref());
        let mut q = QueryParams::new();
        q.opt("cursor", params.cursor.as_ref());
        let query = q.into_pairs();
        let body = None;
    ...
    pub async fn get_user_by_username(&self, username: impl AsRef<str>, params: GetUserByUsernameParams) -> Result<UserData> {
        let path = format!("/v1/twitter/users/{username}/by_username", username = username.as_ref());
        let query: Vec<(String, String)> = Vec::new();
        let body = None;
        self.client.send(Method::GET, &path, &query, body).await
    }
    ...
    pub async fn get_user_followers(&self, username: impl AsRef<str>, params: GetUserFollowersParams) -> Result<UsersResponse> {
        let path = format!("/v1/twitter/users/{username}/followers", username = username.as_ref());
        let mut q = QueryParams::new();
        q.opt("cursor", params.cursor.as_ref());
        let query = q.into_pairs();
        let body = None;
    ...
    pub async fn get_user_followings(&self, username: impl AsRef<str>, params: GetUserFollowingsParams) -> Result<UsersResponse> {
        let path = format!("/v1/twitter/users/{username}/followings", username = username.as_ref());
        let mut q = QueryParams::new();
        q.opt("cursor", params.cursor.as_ref());
        let query = q.into_pairs();
        let body = None;
    ...
    pub async fn get_user_latest_tweets(&self, username: impl AsRef<str>, params: GetUserLatestTweetsParams) -> Result<TweetsResponse> {
        let path = format!("/v1/twitter/users/{username}/latest_tweets", username = username.as_ref());
        let mut q = QueryParams::new();
        q.opt("cursor", params.cursor.as_ref());
        let query = q.into_pairs();
        let body = None;
    ...
    pub async fn get_user_mentions(&self, username: impl AsRef<str>, params: GetUserMentionsParams) -> Result<TweetsResponse> {
        let path = format!("/v1/twitter/users/{username}/mentions", username = username.as_ref());
        let mut q = QueryParams::new();
        q.opt("count", params.count.as_ref());
        q.opt("cursor", params.cursor.as_ref());
        let query = q.into_pairs();
