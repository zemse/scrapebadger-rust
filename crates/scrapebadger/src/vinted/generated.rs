...
impl Vinted {
    ...
    pub async fn get_item_detail(&self, item_id: impl AsRef<str>, params: GetItemDetailParams) -> Result<GetItemDetailResponse> {
    ...
    pub async fn get_user_profile(&self, user_id: impl AsRef<str>, params: GetUserProfileParams) -> Result<GetUserProfileResponse> {
    ...
    pub async fn get_user_items(&self, user_id: impl AsRef<str>, params: GetUserItemsParams) -> Result<GetUserItemsResponse> {
        let path = format!("/v1/vinted/users/{user_id}/items", user_id = user_id.as_ref());
        let mut q = QueryParams::new();
        q.opt("market", params.market.as_ref());
        q.opt("page", params.page.as_ref());
        q.opt("per_page", params.per_page.as_ref());
