...
impl Web {
    ...
    /// `POST /v1/web/detect`
    pub async fn detect_protection(&self, params: DetectProtectionParams) -> Result<DetectProtectionResponse> {
        let path = "/v1/web/detect".to_string();
        let query: Vec<(String, String)> = Vec::new();
        let mut body = serde_json::Map::new();
        if let Some(v) = &params.country { body.insert("country".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.timeout { body.insert("timeout".to_string(), serde_json::json!(v)); }
    ...
    pub async fn scrape_url(&self, params: ScrapeUrlParams) -> Result<ScrapeUrlResponse> {
        ...
        let query: Vec<(String, String)> = Vec::new();
        let mut body = serde_json::Map::new();
        if let Some(v) = &params.ai_extract { body.insert("ai_extract".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.ai_prompt { body.insert("ai_prompt".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.anti_bot { body.insert("anti_bot".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.country { body.insert("country".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.custom_headers { body.insert("custom_headers".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.engine { body.insert("engine".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.escalate { body.insert("escalate".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.format { body.insert("format".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.js_scenario { body.insert("js_scenario".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.max_cost { body.insert("max_cost".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.render_js { body.insert("render_js".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.retry_count { body.insert("retry_count".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.retry_on_block { body.insert("retry_on_block".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.screenshot { body.insert("screenshot".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.session_id { body.insert("session_id".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.url { body.insert("url".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.video { body.insert("video".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.wait_after_load { body.insert("wait_after_load".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.wait_for { body.insert("wait_for".to_string(), serde_json::json!(v)); }
        if let Some(v) = &params.wait_timeout { body.insert("wait_timeout".to_string(), serde_json::json!(v)); }
        let body = if body.is_empty() { None } else { Some(Value::Object(body)) };
        self.client.send(Method::POST, &path, &query, body).await
    }
